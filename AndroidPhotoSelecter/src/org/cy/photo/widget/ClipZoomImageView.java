...
public class ClipZoomImageView extends ImageView implements
		OnScaleGestureListener, ViewTreeObserver.OnGlobalLayoutListener

{
	...
	public boolean onScale(ScaleGestureDetector detector) {
		...
		Log.e(TAG, initScale + " run->" + scale + " SCALE_MAX->" + SCALE_MAX
	...
	public void onGlobalLayout() {
		if (once) {
			...
			if (dh < getHeight() - mVerticalPadding * 2
					&& dw < getWidth() - mHorizontalPadding * 2) {
				float scaleW = (getWidth() * 1.0f - mVerticalPadding * 2) / dw;
				float scaleH = (getHeight() * 1.0f - mHorizontalPadding * 2)
						/ dh;
				scale = Math.max(scaleW, scaleH);
			}
